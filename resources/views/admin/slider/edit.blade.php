...
@section('title', 'Edit Slider - Dashboard Admin')
@section('page-title', 'Edit Slider')
@section('page-subtitle', 'Perbarui informasi slider')
            ...
            <form action="{{ route('admin.slider.update', $slider) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" value="{{ old('judul', $slider->judul) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative w-full h-48 rounded-xl overflow-hidden border-2 border-gray-200">
                    ...
                    <!-- Upload Gambar Baru -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Ganti Gambar Slider</label>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" value="{{ old('urutan', $slider->urutan) }}" min="1" required
                    ...
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="aktif" value="1" {{ old('aktif', $slider->aktif) ? 'checked' : '' }}
