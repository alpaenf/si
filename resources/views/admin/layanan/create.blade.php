...
@section('title', 'Tambah Layanan - Dashboard Admin')
@section('page-title', 'Tambah Layanan')
@section('page-subtitle', 'Tambahkan layanan baru')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" value="{{ old('icon') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition @error('icon') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="5"
                            ...
                            placeholder="Jelaskan detail tentang layanan ini...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
