            ...
            <form action="{{ route('admin.galeri.update', $galeri) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative w-full h-64 rounded-xl overflow-hidden border-2 border-gray-200">
                        ...
                        <div>
                            ...
                            <label for="gambar" id="uploadLabel" class="relative flex flex-col items-center justify-center w-full h-64 px-4 py-8 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary hover:bg-blue-50 transition cursor-pointer overflow-hidden">
                                <div id="placeholderContent" class="text-center">
                                    ...
                                    <p class="text-sm font-medium text-gray-600 mb-1">Klik untuk upload foto baru</p>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', $galeri->tanggal ? \Carbon\Carbon::parse($galeri->tanggal)->format('Y-m-d') : '') }}" required
                    ...
                    <div>
                        ...
                        <select name="kategori" required
                            ...
                            <option value="dokumentasi" {{ old('kategori', $galeri->kategori) == 'dokumentasi' ? 'selected' : '' }}>Dokumentasi</option>
