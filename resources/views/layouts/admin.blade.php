    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col fixed lg:relative h-full z-40">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ Request::is('dashboard') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                ...
                <a href="{{ route('admin.berita.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ Request::is('dashboard/berita*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.dokumen-sakip.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ Request::is('dashboard/dokumen-sakip*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="font-medium">Dokumen SAKIP</span>
                </a>

                <a href="{{ route('admin.layanan.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ Request::is('dashboard/layanan*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.faq.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ Request::is('dashboard/faq*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-700 hover:bg-gray-100 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
