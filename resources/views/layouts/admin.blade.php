    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col fixed lg:relative h-full z-40">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-2">
                ...
                <a href="{{ route('admin.dokumen-sakip.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ Request::is('dashboard/dokumen-sakip*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.layanan.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ Request::is('dashboard/layanan*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.faq.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl {{ Request::is('dashboard/faq*') ? 'sidebar-active' : 'text-gray-700 hover:bg-gray-100' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
